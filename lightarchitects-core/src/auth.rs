...
//! wrapper used by [`crate::StdioTransport::connect`].
//!
//! ## Design
//!
//! ```text
...
///
/// Implement this trait to gate [`crate::StdioTransport::connect`] behind an
...
/// builders and passed to [`crate::StdioTransport::connect`]. No generic
