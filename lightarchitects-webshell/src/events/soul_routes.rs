...
// Convergence types + handler split out to events/soul/convergences.rs
// (task #51 partial). Re-exported via the `pub use` block at the bottom of
// this file so `events::soul_routes::ConvergenceListQuery` etc. still resolve.
...
// ────────────────────────────────────────────────────────────────────────────
// Re-exports from split-out modules (task #51 partial split, 2026-04-30).
// Keeps `events::soul_routes::*` resolving so server/mod.rs (mantis-locked)
// doesn't need editing. Future splits should follow this same pattern.
// ────────────────────────────────────────────────────────────────────────────

pub use super::soul::convergences::{
    ConvergenceListQuery, ConvergenceListResponse, ConvergenceParticipant, ConvergenceSummary,
    convergences_handler,
};
