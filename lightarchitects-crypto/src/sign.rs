...
/// from [`crate::derive::derive_signing_key`] or any 32-byte secret.
///
...
///
/// ```
/// use lightarchitects_crypto::sign::keypair_from_seed;
///
/// let seed = [0x42u8; 32];
...
pub fn sign_with_verse(
    ...
    let derived = crate::derive::derive_key(pepper, &ikm, verse, "signing")?;
