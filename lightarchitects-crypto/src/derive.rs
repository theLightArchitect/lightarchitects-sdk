...
///
/// ```
/// use lightarchitects_crypto::derive::derive_api_key;
/// use lightarchitects_crypto::verses::find_verse;
/// use secrecy::{ExposeSecret, SecretString};
///
/// let pepper = SecretString::from("my-pepper");
...
///
/// ```
/// use lightarchitects_crypto::derive::derive_encryption_key;
/// use secrecy::SecretString;
///
/// let pepper = SecretString::from("my-pepper");
...
///
/// ```
/// use lightarchitects_crypto::derive::derive_signing_key;
/// use secrecy::SecretString;
///
/// let pepper = SecretString::from("my-pepper");
