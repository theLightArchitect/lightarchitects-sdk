...
///
/// ```
/// use lightarchitects_crypto::secrets::{resolve_secret, FileStore, SecretStore};
///
...
///
/// ```
/// use lightarchitects_crypto::secrets::{auto_generate_and_persist, FileStore, SecretStore};
