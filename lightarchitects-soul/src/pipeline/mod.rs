...
//!
//! ```rust,no_run
//! use lightarchitects_soul::pipeline::RetrievalPipeline;
//! use lightarchitects_soul::sqlite::SqliteBackend;
//! use std::sync::Arc;
//!
//! # async fn example() -> Result<(), lightarchitects_soul::pipeline::PipelineError> {
