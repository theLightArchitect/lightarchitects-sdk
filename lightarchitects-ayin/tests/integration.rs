//! Integration tests for `lightarchitects-ayin`.
//!
...
//! `lightarchitects-ayin/src/lib.rs` (not possible to integration-test here without the
...
use lightarchitects_core::{JsonRpcRequest, SdkError};
