...
//! [`lightarchitects_soul::SoulDb`] so callers can swap backends without
...
//! use lightarchitects_helix::HelixStore;
//!
...
use lightarchitects_soul::{RetrievalHit, RetrievalSignal};
use thiserror::Error;

use crate::{HelixDb as _, HelixNeo4j, HelixOrderingMode, Neo4jConfig, SearchOptions, Step};
...
impl From<crate::HelixDbError> for HelixStoreError {
    fn from(e: crate::HelixDbError) -> Self {
...
/// [`lightarchitects_soul::SoulDb`]. Use this type when your application
...
impl HelixStore {
    ...
    /// [`lightarchitects_soul::SoulDb::search`] — enabling backend-agnostic
    /// retrieval code.
    #[must_use]
