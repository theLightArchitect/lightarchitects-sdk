...
// All callers that use `lightarchitects_helix::EmbeddingProvider` etc. continue
// to work unchanged — the re-export preserves type identity.
pub use lightarchitects_soul::{EmbeddingError, EmbeddingProvider, EmbeddingResult, PrivacyLevel};
