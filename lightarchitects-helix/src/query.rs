...
//!
//! ```rust,no_run
//! use lightarchitects_helix::query::HelixQuery;
//! use lightarchitects_helix::types::HelixOrderingMode;
//!
...
use crate::types::HelixOrderingMode;
...
impl HelixQuery {
    ...
    /// Maximum drill-down depth, capped at [`crate::types::MAX_TRAVERSAL_DEPTH`].
    #[must_use]
    pub fn depth(mut self, depth: u8) -> Self {
        self.depth = Some(depth.min(crate::types::MAX_TRAVERSAL_DEPTH));
        self
    }
    ...
    pub fn effective_depth(&self) -> u8 {
        self.depth
            .unwrap_or(crate::types::MAX_TRAVERSAL_DEPTH)
            .min(crate::types::MAX_TRAVERSAL_DEPTH)
    }
}
...
mod tests {
    ...
    fn test_depth_clamped() {
        ...
        assert_eq!(q.effective_depth(), crate::types::MAX_TRAVERSAL_DEPTH);
    }
