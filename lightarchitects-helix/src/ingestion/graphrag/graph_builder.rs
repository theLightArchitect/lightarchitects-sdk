...
use crate::types::{Helix, HelixLink, HelixOrderingMode, LinkType, MAX_TRAVERSAL_DEPTH, Step};
...
pub enum GraphBuildError {
    ...
    Database(#[from] crate::db::HelixDbError),
...
mod tests {
    use super::*;
    use crate::ingestion::graphrag::entity_extractor::{Entity, Extraction, Relation};
