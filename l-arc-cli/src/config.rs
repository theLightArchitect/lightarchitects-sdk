...
/// - `L_ARC_SOUL_BIN`, `L_ARC_CORSO_BIN`, `L_ARC_EVA_BIN`,
///   `L_ARC_QUANTUM_BIN`, `L_ARC_SERAPH_BIN`
#[derive(Debug, Clone)]
...
impl CliConfig {
    ...
    pub fn resolve() -> Self {
        ...
        Self {
            soul: env_or("L_ARC_SOUL_BIN", home.join(".soul/.config/bin/soul")),
            corso: env_or("L_ARC_CORSO_BIN", home.join(".corso/bin/corso")),
            eva: env_or("L_ARC_EVA_BIN", home.join(".eva/bin/eva")),
            quantum: env_or("L_ARC_QUANTUM_BIN", home.join(".quantum/bin/quantum-q")),
            seraph: env_or("L_ARC_SERAPH_BIN", home.join(".seraph/bin/seraph")),
        }
    }
