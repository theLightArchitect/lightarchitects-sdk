<!-- uuid: 05d188c5-3009-49b7-bb32-48054bbc9a28 -->
<!-- source: https://opentelemetry.io/docs/specs/otel/metrics/api/ | version: 1.56.0 | scraped: 2026-05-12 | tool: firecrawl v1.10.0 | re-pull: per REGISTRY.md policy -->
<!-- gate: [O] -->
...
- [EnglishEN](https://opentelemetry.io/docs/specs/otel/metrics/api/#)
...
[View Markdown](https://opentelemetry.io/docs/specs/otel/metrics/api/index.md) [View page source](https://github.com/open-telemetry/opentelemetry-specification/tree/main/specification/metrics/api.md) [Edit this page](https://github.com/open-telemetry/opentelemetry-specification/edit/main/specification/metrics/api.md) [Create child page](https://github.com/open-telemetry/opentelemetry-specification/new/main/specification/metrics?filename=change-me.md&value=---%0Atitle%3A+%22Long+Page+Title%22%0AlinkTitle%3A+%22Short+Nav+Title%22%0Aweight%3A+100%0Adescription%3A+%3E-%0A+++++Page+description+for+heading+and+indexes.%0A---%0A%0A%23%23+Heading%0A%0AEdit+this+template+to+create+your+new+page.%0A%0A%2A+Give+it+a+good+name%2C+ending+in+%60.md%60+-+e.g.+%60get-started.md%60%0A%2A+Edit+the+%22front+matter%22+section+at+the+top+of+the+page+%28weight+controls+how+its+ordered+amongst+other+pages+in+the+same+directory%3B+lowest+number+first%29.%0A%2A+Add+a+good+commit+message+at+the+bottom+of+the+page+%28%3C80+characters%3B+use+the+extended+description+field+for+more+detail%29.%0A%2A+Create+a+new+branch+so+you+can+preview+your+new+file+and+request+a+review+via+Pull+Request.%0A) [Create documentation issue](https://github.com/open-telemetry/opentelemetry-specification/issues/new?title=Metrics%20API) [Create project issue](https://github.com/open-telemetry/opentelemetry-specification/issues/new)

On this page [Top of page](https://opentelemetry.io/docs/specs/otel/metrics/api/# "Top of page")

- [Overview](https://opentelemetry.io/docs/specs/otel/metrics/api/#overview)
- [MeterProvider](https://opentelemetry.io/docs/specs/otel/metrics/api/#meterprovider)
  - [MeterProvider operations](https://opentelemetry.io/docs/specs/otel/metrics/api/#meterprovider-operations)
    - [Get a Meter](https://opentelemetry.io/docs/specs/otel/metrics/api/#get-a-meter)
- [Meter](https://opentelemetry.io/docs/specs/otel/metrics/api/#meter)
  - [Meter operations](https://opentelemetry.io/docs/specs/otel/metrics/api/#meter-operations)
- [Instrument](https://opentelemetry.io/docs/specs/otel/metrics/api/#instrument)
  - [General characteristics](https://opentelemetry.io/docs/specs/otel/metrics/api/#general-characteristics)
    ...
    - [Instrument advisory parameters](https://opentelemetry.io/docs/specs/otel/metrics/api/#instrument-advisory-parameters)
      - [Instrument advisory parameter: `ExplicitBucketBoundaries`](https://opentelemetry.io/docs/specs/otel/metrics/api/#instrument-advisory-parameter-explicitbucketboundaries)
      - [Instrument advisory parameter: `Attributes`](https://opentelemetry.io/docs/specs/otel/metrics/api/#instrument-advisory-parameter-attributes)
    - [Synchronous and Asynchronous instruments](https://opentelemetry.io/docs/specs/otel/metrics/api/#synchronous-and-asynchronous-instruments)
      - [Synchronous Instrument API](https://opentelemetry.io/docs/specs/otel/metrics/api/#synchronous-instrument-api)
      - [Asynchronous Instrument API](https://opentelemetry.io/docs/specs/otel/metrics/api/#asynchronous-instrument-api)
  - [General operations](https://opentelemetry.io/docs/specs/otel/metrics/api/#general-operations)
    - [Enabled](https://opentelemetry.io/docs/specs/otel/metrics/api/#enabled)
  - [Counter](https://opentelemetry.io/docs/specs/otel/metrics/api/#counter)
    - [Counter creation](https://opentelemetry.io/docs/specs/otel/metrics/api/#counter-creation)
    - [Counter operations](https://opentelemetry.io/docs/specs/otel/metrics/api/#counter-operations)
      - [Add](https://opentelemetry.io/docs/specs/otel/metrics/api/#add)
  - [Asynchronous Counter](https://opentelemetry.io/docs/specs/otel/metrics/api/#asynchronous-counter)
    - [Asynchronous Counter creation](https://opentelemetry.io/docs/specs/otel/metrics/api/#asynchronous-counter-creation)
    - [Asynchronous Counter operations](https://opentelemetry.io/docs/specs/otel/metrics/api/#asynchronous-counter-operations)
  - [Histogram](https://opentelemetry.io/docs/specs/otel/metrics/api/#histogram)
    - [Histogram creation](https://opentelemetry.io/docs/specs/otel/metrics/api/#histogram-creation)
    - [Histogram operations](https://opentelemetry.io/docs/specs/otel/metrics/api/#histogram-operations)
      - [Record](https://opentelemetry.io/docs/specs/otel/metrics/api/#record)
  - [Gauge](https://opentelemetry.io/docs/specs/otel/metrics/api/#gauge)
    - [Gauge creation](https://opentelemetry.io/docs/specs/otel/metrics/api/#gauge-creation)
    - [Gauge operations](https://opentelemetry.io/docs/specs/otel/metrics/api/#gauge-operations)
      - [Record](https://opentelemetry.io/docs/specs/otel/metrics/api/#record-1)
  - [Asynchronous Gauge](https://opentelemetry.io/docs/specs/otel/metrics/api/#asynchronous-gauge)
    - [Asynchronous Gauge creation](https://opentelemetry.io/docs/specs/otel/metrics/api/#asynchronous-gauge-creation)
    - [Asynchronous Gauge operations](https://opentelemetry.io/docs/specs/otel/metrics/api/#asynchronous-gauge-operations)
  - [UpDownCounter](https://opentelemetry.io/docs/specs/otel/metrics/api/#updowncounter)
    - [UpDownCounter creation](https://opentelemetry.io/docs/specs/otel/metrics/api/#updowncounter-creation)
    - [UpDownCounter operations](https://opentelemetry.io/docs/specs/otel/metrics/api/#updowncounter-operations)
      - [Add](https://opentelemetry.io/docs/specs/otel/metrics/api/#add-1)
  - [Asynchronous UpDownCounter](https://opentelemetry.io/docs/specs/otel/metrics/api/#asynchronous-updowncounter)
    - [Asynchronous UpDownCounter creation](https://opentelemetry.io/docs/specs/otel/metrics/api/#asynchronous-updowncounter-creation)
    - [Asynchronous UpDownCounter operations](https://opentelemetry.io/docs/specs/otel/metrics/api/#asynchronous-updowncounter-operations)
- [Measurement](https://opentelemetry.io/docs/specs/otel/metrics/api/#measurement)
  - [Multiple-instrument callbacks](https://opentelemetry.io/docs/specs/otel/metrics/api/#multiple-instrument-callbacks)
- [Compatibility requirements](https://opentelemetry.io/docs/specs/otel/metrics/api/#compatibility-requirements)
- [Concurrency requirements](https://opentelemetry.io/docs/specs/otel/metrics/api/#concurrency-requirements)
- [References](https://opentelemetry.io/docs/specs/otel/metrics/api/#references)
...
4. [Metrics](https://opentelemetry.io/docs/specs/otel/metrics/)
5. API
...
## Overview [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/api/\#overview)

The Metrics API consists of these main components:

- [MeterProvider](https://opentelemetry.io/docs/specs/otel/metrics/api/#meterprovider) is the entry point of the API. It provides
access to `Meters`.
- [Meter](https://opentelemetry.io/docs/specs/otel/metrics/api/#meter) is responsible for creating `Instruments`.
- [Instrument](https://opentelemetry.io/docs/specs/otel/metrics/api/#instrument) is responsible for reporting
[Measurements](https://opentelemetry.io/docs/specs/otel/metrics/api/#measurement).
...
### MeterProvider operations [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/api/\#meterprovider-operations)

The `MeterProvider` MUST provide the following functions:

- Get a `Meter`

#### Get a Meter [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/api/\#get-a-meter)

This API MUST accept the following parameters:

- `name`: Specifies the name of the [instrumentation\\
scope](https://opentelemetry.io/docs/specs/otel/common/instrumentation-scope/), such as the
...
library](https://opentelemetry.io/docs/specs/otel/glossary/#instrumented-library) and [Instrumentation\\
library](https://opentelemetry.io/docs/specs/otel/glossary/#instrumentation-library) can refer to the same
...
The term _identical_ applied to Meters describes instances where all parameters
are equal. The term _distinct_ applied to Meters describes instances where at
least one parameter has a different value.

## Meter [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/api/\#meter)

The meter is responsible for creating [Instruments](https://opentelemetry.io/docs/specs/otel/metrics/api/#instrument).

Note: `Meter` SHOULD NOT be responsible for the configuration. This should be
the responsibility of the `MeterProvider` instead.

### Meter operations [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/api/\#meter-operations)

The `Meter` MUST provide functions to create new [Instruments](https://opentelemetry.io/docs/specs/otel/metrics/api/#instrument):

- [Create a new Counter](https://opentelemetry.io/docs/specs/otel/metrics/api/#counter-creation)
- [Create a new Asynchronous Counter](https://opentelemetry.io/docs/specs/otel/metrics/api/#asynchronous-counter-creation)
- [Create a new Histogram](https://opentelemetry.io/docs/specs/otel/metrics/api/#histogram-creation)
- [Create a new Gauge](https://opentelemetry.io/docs/specs/otel/metrics/api/#gauge-creation)
- [Create a new Asynchronous Gauge](https://opentelemetry.io/docs/specs/otel/metrics/api/#asynchronous-gauge-creation)
- [Create a new UpDownCounter](https://opentelemetry.io/docs/specs/otel/metrics/api/#updowncounter-creation)
- [Create a new Asynchronous UpDownCounter](https://opentelemetry.io/docs/specs/otel/metrics/api/#asynchronous-updowncounter-creation)

Also see the respective sections below for more information on instrument creation.

## Instrument [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/api/\#instrument)

Instruments are used to report [Measurements](https://opentelemetry.io/docs/specs/otel/metrics/api/#measurement). Each Instrument
will have the following parameters:

- The [`name`](https://opentelemetry.io/docs/specs/otel/metrics/api/#instrument-name-syntax) of the Instrument
- The `kind` of the Instrument - whether it is a [Counter](https://opentelemetry.io/docs/specs/otel/metrics/api/#counter) or
one of the other kinds, whether it is synchronous or asynchronous
- An optional [`unit`](https://opentelemetry.io/docs/specs/otel/metrics/api/#instrument-unit) of measure
- An optional [`description`](https://opentelemetry.io/docs/specs/otel/metrics/api/#instrument-description)
- Optional [`advisory`](https://opentelemetry.io/docs/specs/otel/metrics/api/#instrument-advisory-parameters) parameters ( **mixed**)
...
The term _identical_ applied to an Instrument describes instances where all
identifying fields are equal.

### General characteristics [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/api/\#general-characteristics)

#### Instrument name syntax [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/api/\#instrument-name-syntax)
...
#### Instrument unit [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/api/\#instrument-unit)
...
#### Instrument description [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/api/\#instrument-description)
...
0)](https://en.wikipedia.org/wiki/Plane_%28Unicode%29#Basic_Multilingual_Plane),
which is basically only the first three bytes of UTF-8 (or `utf8mb3`).
[OpenTelemetry API](https://opentelemetry.io/docs/specs/otel/overview/#api) authors MAY decide if they want to
support more Unicode [Planes](https://en.wikipedia.org/wiki/Plane_%28Unicode%29).
- It MUST support at least 1023 characters. [OpenTelemetry\\
API](https://opentelemetry.io/docs/specs/otel/overview/#api) authors MAY decide if they want to support more.

#### Instrument advisory parameters [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/api/\#instrument-advisory-parameters)

**Status**: [Mixed](https://opentelemetry.io/docs/specs/otel/document-status/)
...
[here](https://opentelemetry.io/docs/specs/otel/metrics/sdk/#instrument-advisory-parameters).

`advisory` parameters may be general, or may be accepted only for specific
instrument `kind`s.

##### Instrument advisory parameter: `ExplicitBucketBoundaries` [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/api/\#instrument-advisory-parameter-explicitbucketboundaries)
...
[explicit bucket Histogram metric data point](https://opentelemetry.io/docs/specs/otel/metrics/data-model/#histogram).

##### Instrument advisory parameter: `Attributes` [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/api/\#instrument-advisory-parameter-attributes)

**Status**: [Development](https://opentelemetry.io/docs/specs/otel/document-status/)

Applies to all instrument types.

`Attributes` (a list of [attribute keys](https://opentelemetry.io/docs/specs/otel/common/#attribute)) is
the recommended set of attribute keys to be used for the resulting metrics.

#### Synchronous and Asynchronous instruments [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/api/\#synchronous-and-asynchronous-instruments)

Instruments are categorized on whether they are synchronous or
asynchronous:

- Synchronous instruments (e.g. [Counter](https://opentelemetry.io/docs/specs/otel/metrics/api/#counter)) are meant to be invoked
...
[Measurements](https://opentelemetry.io/docs/specs/otel/metrics/api/#measurement) recorded by synchronous instruments can be
associated with the [Context](https://opentelemetry.io/docs/specs/otel/context/).

- Asynchronous instruments (e.g. [Asynchronous Gauge](https://opentelemetry.io/docs/specs/otel/metrics/api/#asynchronous-gauge)) give
the user a way to register callback function, and the callback function will
be invoked only on demand (see SDK [collection](https://opentelemetry.io/docs/specs/otel/metrics/sdk/#collect) for reference). For example, a piece of embedded software
...
seconds. [Measurements](https://opentelemetry.io/docs/specs/otel/metrics/api/#measurement) recorded by asynchronous instruments
cannot be associated with the [Context](https://opentelemetry.io/docs/specs/otel/context/).
...
##### Synchronous Instrument API [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/api/\#synchronous-instrument-api)
...
syntax](https://opentelemetry.io/docs/specs/otel/metrics/api/#instrument-name-syntax). The API SHOULD NOT validate the `name`; that
is left to implementations of the API, like the [SDK](https://opentelemetry.io/docs/specs/otel/metrics/sdk/#instrument-name).
...
rule](https://opentelemetry.io/docs/specs/otel/metrics/api/#instrument-unit). Meaning, the API MUST accept a case-sensitive string
...
rule](https://opentelemetry.io/docs/specs/otel/metrics/api/#instrument-description). Meaning, the API MUST accept a string that
...
[instrument advisory parameters](https://opentelemetry.io/docs/specs/otel/metrics/api/#instrument-advisory-parameters), with
parameters that are general and specific to a particular instrument `kind`.
The API SHOULD NOT validate `advisory` parameters.


##### Asynchronous Instrument API [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/api/\#asynchronous-instrument-api)

Asynchronous instruments have associated `callback` functions which
are responsible for reporting [Measurement](https://opentelemetry.io/docs/specs/otel/metrics/api/#measurement) s. Callback
...
The API SHOULD be documented in a way to communicate to users that the `name`
parameter needs to conform to the [instrument name\\
syntax](https://opentelemetry.io/docs/specs/otel/metrics/api/#instrument-name-syntax). The API SHOULD NOT validate the `name`,
...
- `callback` functions that report [Measurements](https://opentelemetry.io/docs/specs/otel/metrics/api/#measurement) of the created
instrument.
...
[OpenTelemetry API](https://opentelemetry.io/docs/specs/otel/overview/#api) authors MAY decide what is the idiomatic
...
`Measurement` values.
- Pass an _Observable Result_ as a formal parameter of the callback,
...
use by a configured [View](https://opentelemetry.io/docs/specs/otel/metrics/sdk/#view).
...
callback. [OpenTelemetry API](https://opentelemetry.io/docs/specs/otel/overview/#api) authors MAY decide
...
### General operations [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/api/\#general-operations)

All [synchronous instruments](https://opentelemetry.io/docs/specs/otel/metrics/api/#synchronous-instrument-api) SHOULD provide functions to:

- [Report if instrument is `Enabled`](https://opentelemetry.io/docs/specs/otel/metrics/api/#enabled)

#### Enabled [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/api/\#enabled)

To help users avoid performing computationally expensive operations when
recording measurements, [synchronous instruments](https://opentelemetry.io/docs/specs/otel/metrics/api/#synchronous-instrument-api)
...
### Counter [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/api/\#counter)

`Counter` is a [synchronous Instrument](https://opentelemetry.io/docs/specs/otel/metrics/api/#synchronous-instrument-api) which supports
...
#### Counter creation [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/api/\#counter-creation)

There MUST NOT be any API for creating a `Counter` other than with a
[`Meter`](https://opentelemetry.io/docs/specs/otel/metrics/api/#meter). This MAY be called `CreateCounter`. If strong type is
desired, [OpenTelemetry API](https://opentelemetry.io/docs/specs/otel/overview/#api) authors MAY decide the language
...
Here are some examples that [OpenTelemetry API](https://opentelemetry.io/docs/specs/otel/overview/#api) authors
might consider:
...
#### Counter operations [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/api/\#counter-operations)

##### Add [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/api/\#add)
...
- [Attributes](https://opentelemetry.io/docs/specs/otel/common/#attribute) to associate with the increment
value.
...
The [OpenTelemetry API](https://opentelemetry.io/docs/specs/otel/overview/#api) authors MAY decide to allow flexible
[attributes](https://opentelemetry.io/docs/specs/otel/common/#attribute) to be passed in as arguments. If
the attribute names and types are provided during the [counter\\
creation](https://opentelemetry.io/docs/specs/otel/metrics/api/#counter-creation), the [OpenTelemetry API](https://opentelemetry.io/docs/specs/otel/overview/#api)
...
are some examples that [OpenTelemetry API](https://opentelemetry.io/docs/specs/otel/overview/#api) authors might
consider:
...
### Asynchronous Counter [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/api/\#asynchronous-counter)

Asynchronous Counter is an [asynchronous Instrument](https://opentelemetry.io/docs/specs/otel/metrics/api/#asynchronous-instrument-api)
...
#### Asynchronous Counter creation [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/api/\#asynchronous-counter-creation)

There MUST NOT be any API for creating an Asynchronous Counter other than with a
[`Meter`](https://opentelemetry.io/docs/specs/otel/metrics/api/#meter). This MAY be called `CreateObservableCounter`. If strong type
is desired, [OpenTelemetry API](https://opentelemetry.io/docs/specs/otel/overview/#api) authors MAY decide the
...
See the [general requirements for asynchronous instruments](https://opentelemetry.io/docs/specs/otel/metrics/api/#asynchronous-instrument-api).

Note: Unlike [Counter.Add()](https://opentelemetry.io/docs/specs/otel/metrics/api/#add) which takes the increment/delta value, the
...
SDK](https://opentelemetry.io/docs/specs/otel/overview/#sdk) authors MAY decide how to handle it in the
[SDK](https://opentelemetry.io/docs/specs/otel/metrics/#sdk). For example, during the callback invocation if two
measurements `value=1, attributes={pid:4, bitness:64}` and `value=2, attributes={pid:4, bitness:64}` are reported, [OpenTelemetry\\
SDK](https://opentelemetry.io/docs/specs/otel/overview/#sdk) authors MAY decide to simply let them pass through (so
...
API](https://opentelemetry.io/docs/specs/otel/overview/#api) authors MAY decide what is the idiomatic approach (e.g.
...
#### Asynchronous Counter operations [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/api/\#asynchronous-counter-operations)
...
### Histogram [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/api/\#histogram)

`Histogram` is a [synchronous Instrument](https://opentelemetry.io/docs/specs/otel/metrics/api/#synchronous-instrument-api) which can be
...
#### Histogram creation [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/api/\#histogram-creation)

There MUST NOT be any API for creating a `Histogram` other than with a
[`Meter`](https://opentelemetry.io/docs/specs/otel/metrics/api/#meter). This MAY be called `CreateHistogram`. If strong type is
desired, [OpenTelemetry API](https://opentelemetry.io/docs/specs/otel/overview/#api) authors MAY decide the language
...
#### Histogram operations [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/api/\#histogram-operations)

##### Record [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/api/\#record)
...
- [Attributes](https://opentelemetry.io/docs/specs/otel/common/#attribute) to associate with the value.
...
[OpenTelemetry API](https://opentelemetry.io/docs/specs/otel/overview/#api) authors MAY decide to allow flexible
[attributes](https://opentelemetry.io/docs/specs/otel/common/#attribute) to be passed in as individual
arguments. [OpenTelemetry API](https://opentelemetry.io/docs/specs/otel/overview/#api) authors MAY allow attribute
...
API](https://opentelemetry.io/docs/specs/otel/overview/#api) authors might consider:
...
### Gauge [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/api/\#gauge)

`Gauge` is a [synchronous Instrument](https://opentelemetry.io/docs/specs/otel/metrics/api/#synchronous-instrument-api) which can be
...
total heap usage), use [UpDownCounter](https://opentelemetry.io/docs/specs/otel/metrics/api/#asynchronous-updowncounter).
...
use [Asynchronous Gauge](https://opentelemetry.io/docs/specs/otel/metrics/api/#asynchronous-gauge) to invoke the accessor in a
callback function (
...
#### Gauge creation [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/api/\#gauge-creation)

There MUST NOT be any API for creating a `Gauge` other than with a
[`Meter`](https://opentelemetry.io/docs/specs/otel/metrics/api/#meter). This MAY be called `CreateGauge`. If strong type is
desired, [OpenTelemetry API](https://opentelemetry.io/docs/specs/otel/overview/#api) authors MAY decide the language
...
#### Gauge operations [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/api/\#gauge-operations)

##### Record [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/api/\#record-1)
...
creation](https://opentelemetry.io/docs/specs/otel/metrics/api/#gauge-creation), the [OpenTelemetry API](https://opentelemetry.io/docs/specs/otel/overview/#api)
authors MAY allow attribute values to be passed in using a more efficient way
(e.g. strong typed struct allocated on the callstack, tuple). The API MUST allow
callers to provide flexible attributes at invocation time rather than having to
register all the possible attribute names during the instrument creation. Here
...
### Asynchronous Gauge [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/api/\#asynchronous-gauge)

Asynchronous Gauge is an [asynchronous Instrument](https://opentelemetry.io/docs/specs/otel/metrics/api/#asynchronous-instrument-api)
...
total heap usage), use [Asynchronous Counter](https://opentelemetry.io/docs/specs/otel/metrics/api/#asynchronous-counter) or
[Asynchronous UpDownCounter](https://opentelemetry.io/docs/specs/otel/metrics/api/#asynchronous-updowncounter).
...
#### Asynchronous Gauge creation [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/api/\#asynchronous-gauge-creation)

There MUST NOT be any API for creating an Asynchronous Gauge other than with a
[`Meter`](https://opentelemetry.io/docs/specs/otel/metrics/api/#meter). This MAY be called `CreateObservableGauge`. If strong type is
desired, [OpenTelemetry API](https://opentelemetry.io/docs/specs/otel/overview/#api) authors MAY decide the language
...
#### Asynchronous Gauge operations [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/api/\#asynchronous-gauge-operations)
...
### UpDownCounter [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/api/\#updowncounter)

`UpDownCounter` is a [synchronous Instrument](https://opentelemetry.io/docs/specs/otel/metrics/api/#synchronous-instrument-api) which
...
[Counter](https://opentelemetry.io/docs/specs/otel/metrics/api/#counter) instead.
...
#### UpDownCounter creation [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/api/\#updowncounter-creation)

There MUST NOT be any API for creating an `UpDownCounter` other than with a
[`Meter`](https://opentelemetry.io/docs/specs/otel/metrics/api/#meter). This MAY be called `CreateUpDownCounter`. If strong type is
desired, [OpenTelemetry API](https://opentelemetry.io/docs/specs/otel/overview/#api) authors MAY decide the language
...
#### UpDownCounter operations [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/api/\#updowncounter-operations)

##### Add [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/api/\#add-1)
...
### Asynchronous UpDownCounter [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/api/\#asynchronous-updowncounter)

Asynchronous UpDownCounter is an [asynchronous\\
Instrument](https://opentelemetry.io/docs/specs/otel/metrics/api/#asynchronous-instrument-api) which reports additive value(s) (e.g. the
...
Note: if the value is
[monotonically](https://en.wikipedia.org/wiki/Monotonic_function) increasing, use
[Asynchronous Counter](https://opentelemetry.io/docs/specs/otel/metrics/api/#asynchronous-counter) instead; if the value is
non-additive, use [Asynchronous Gauge](https://opentelemetry.io/docs/specs/otel/metrics/api/#asynchronous-gauge) instead.
...
#### Asynchronous UpDownCounter creation [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/api/\#asynchronous-updowncounter-creation)

There MUST NOT be any API for creating an Asynchronous UpDownCounter other than
with a [`Meter`](https://opentelemetry.io/docs/specs/otel/metrics/api/#meter). This MAY be called `CreateObservableUpDownCounter`. If
strong type is desired, [OpenTelemetry API](https://opentelemetry.io/docs/specs/otel/overview/#api) authors MAY
...
Note: Unlike [UpDownCounter.Add()](https://opentelemetry.io/docs/specs/otel/metrics/api/#add-1) which takes the increment/delta value,
...
#### Asynchronous UpDownCounter operations [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/api/\#asynchronous-updowncounter-operations)
...
## Measurement [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/api/\#measurement)

A `Measurement` represents a data point reported via the metrics API to the SDK.
Please refer to the [Metrics Programming Model](https://opentelemetry.io/docs/specs/otel/metrics/#programming-model)
...
### Multiple-instrument callbacks [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/api/\#multiple-instrument-callbacks)

[The Metrics API MAY support an interface allowing the use of multiple\\
instruments from a single registered\\
Callback](https://opentelemetry.io/docs/specs/otel/metrics/api/#asynchronous-instrument-api). The API to register a new
...
## Compatibility requirements [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/api/\#compatibility-requirements)
...
## Concurrency requirements [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/api/\#concurrency-requirements)
...
## References [Heading self-link](https://opentelemetry.io/docs/specs/otel/metrics/api/\#references)

- [OTEP0003 Consolidate pre-aggregated and raw metrics APIs](https://github.com/open-telemetry/opentelemetry-specification/tree/v1.56.0/oteps/metrics/0003-measure-metric-type.md)
- [OTEP0008 Metrics observer specification](https://github.com/open-telemetry/opentelemetry-specification/tree/v1.56.0/oteps/metrics/0008-metric-observer.md)
- [OTEP0009 Metric Handle API specification](https://github.com/open-telemetry/opentelemetry-specification/tree/v1.56.0/oteps/metrics/0009-metric-handles.md)
- [OTEP0010 Rename “Cumulative” to “Counter” in the metrics API](https://github.com/open-telemetry/opentelemetry-specification/tree/v1.56.0/oteps/metrics/0010-cumulative-to-counter.md)
- [OTEP0049 Metric `LabelSet` specification](https://github.com/open-telemetry/opentelemetry-specification/tree/v1.56.0/oteps/metrics/0049-metric-label-set.md)
- [OTEP0070 Rename metric instrument Handles to “Bound Instruments”](https://github.com/open-telemetry/opentelemetry-specification/tree/v1.56.0/oteps/metrics/0070-metric-bound-instrument.md)
- [OTEP0072 Metric observer specification (refinement)](https://github.com/open-telemetry/opentelemetry-specification/tree/v1.56.0/oteps/metrics/0072-metric-observer.md)
- [OTEP0080 Remove the Metric API Gauge instrument](https://github.com/open-telemetry/opentelemetry-specification/tree/v1.56.0/oteps/metrics/0080-remove-metric-gauge.md)
- [OTEP0088 Metric Instruments](https://github.com/open-telemetry/opentelemetry-specification/tree/v1.56.0/oteps/metrics/0088-metric-instrument-optional-refinements.md)
- [OTEP0090 Remove the LabelSet object from the metrics API](https://github.com/open-telemetry/opentelemetry-specification/tree/v1.56.0/oteps/metrics/0090-remove-labelset-from-metrics-api.md)
- [OTEP0098 Explain the metric instruments](https://github.com/open-telemetry/opentelemetry-specification/tree/v1.56.0/oteps/metrics/0098-metric-instruments-explained.md)
- [OTEP0108 Metric instrument naming guidelines](https://github.com/open-telemetry/opentelemetry-specification/tree/v1.56.0/oteps/metrics/0108-naming-guidelines.md)
- [OTEP0146 Scenarios for Metrics API/SDK Prototyping](https://github.com/open-telemetry/opentelemetry-specification/tree/v1.56.0/oteps/metrics/0146-metrics-prototype-scenarios.md)
