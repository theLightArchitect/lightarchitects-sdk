<!-- uuid: bc0cf2a0-2860-42bc-9cf9-d47b707ac17e -->
<!-- source: https://slsa.dev/spec/v1.2/about | version: v1.2 (final, Nov 2025) | scraped: 2026-05-12 | tool: firecrawl v1.10.0 | re-pull: per REGISTRY.md policy -->
<!-- gate: [S] -->
...
- [What is SLSA?](https://slsa.dev/spec/v1.2/about#what-is-slsa)
- [Why SLSA is needed](https://slsa.dev/spec/v1.2/about#why-slsa-is-needed)
- [SLSA in layperson’s terms](https://slsa.dev/spec/v1.2/about#slsa-in-laypersons-terms)
- [Who is SLSA for?](https://slsa.dev/spec/v1.2/about#who-is-slsa-for)
- [How SLSA works](https://slsa.dev/spec/v1.2/about#how-slsa-works)
- [What SLSA doesn’t cover](https://slsa.dev/spec/v1.2/about#what-slsa-doesnt-cover)
...
We talk about SLSA in terms of [tracks and levels](https://slsa.dev/spec/v1.2/tracks).
...
to be possible in [future revisions](https://slsa.dev/spec/v1.2/future-directions).
...
see the [FAQ](https://slsa.dev/spec/v1.2/faq#q-why-is-slsa-not-transitive).

[‹ What's new](https://slsa.dev/spec/v1.2/whats-new) [Supply chain threats ›](https://slsa.dev/spec/v1.2/threats-overview)
...
[View source on GitHub](https://github.com/slsa-framework/slsa/blob/releases/v1.2/spec/about.md?plain=1)
