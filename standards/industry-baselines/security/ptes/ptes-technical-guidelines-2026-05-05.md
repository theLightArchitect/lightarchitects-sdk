...
| Maltego | [http://www.paterva.com/web5](http://www.paterva.com/web5) | The defacto standard for mining data on individuals and companies. Comes in a free community version and paid version. |  |
| Nessus | [http://tenable.com/products/nessus](http://tenable.com/products/nessus) | A vulnerabilty scanning tool available in paid and free versions. Nessus is useful for finding and documenting vulnerabilities mostly from the inside of a given network. |  |
| IBM AppScan | [http://www-01.ibm.com/software/awdtools/appscan](http://www-01.ibm.com/software/awdtools/appscan) | IBM's automated Web application security testing suite. | **\*** |
| eEye Retina | [http://www.eeye.com/Products/Retina.aspx](http://www.eeye.com/Products/Retina.aspx) | Retina is an an automated network vulnerability scanner that can be managed from a single web-based console. It can be used in conjunction with Metasploit where if an exploit exists in Metasploit, it can be launched directly from Retina to verify that the vulnerability exists. |  |
...
| HP WebInspect | [https://www.fortify.com/products/web\_inspect.html](https://www.fortify.com/products/web_inspect.html) | HP WebInspect performs web application security testing and assessment for complex web applications. Supports JavaScript, Flash, Silverlight and others. | **\*** |
| HP SWFScan | [https://h30406.www3.hp.com/campaigns/2009/wwcampaign/1-5TUVE/index.php?key=swf](https://h30406.www3.hp.com/campaigns/2009/wwcampaign/1-5TUVE/index.php?key=swf) | HP SWFScan is a free tool developed by HP Web Security Research Group to automatically find security vulnerabilities in applications built on the Flash platform. Useful for decompiling flash apps and finding hard-coded credentials, etc. | **\*** |
...
| SiteDigger | [http://www.mcafee.com/us/downloads/free-tools/sitedigger.aspx](http://www.mcafee.com/us/downloads/free-tools/sitedigger.aspx) | SiteDigger 3.0 is a free tool that runs on Windows. It searches Google’s cache to look for vulnerabilities, errors, configuration issues, proprietary information, and interesting security nuggets on web sites. | **\*** |
| FOCA | [http://www.informatica64.com/DownloadFOCA](http://www.informatica64.com/DownloadFOCA) | FOCA is a tool that allows you to find out more about a website by (amongst other things) analysing the metadata in any documents it makes available. | **\*** |
| THC IPv6 Attack Toolkit | [http://www.thc.org/thc-ipv6](http://www.thc.org/thc-ipv6) | The largest single collection of tools designed to exploit vulnerabilities in the IPv6 and ICMP6 protocols. |  |
| THC Hydra | [http://thc.org/thc-hydra/](http://thc.org/thc-hydra/) | Hydra is a very fast network logon brute force cracker which can attack many different services and resources. | **\*** |
| Cain | [http://www.oxid.it/cain.html](http://www.oxid.it/cain.html) | Cain & Abel is a password recovery tool that runs on Windows. It allows easy recovery of various kind of passwords by sniffing the network, cracking encrypted passwords using Dictionary, Brute-Force and Cryptanalysis attacks, recording VoIP conversations, decoding scrambled passwords, recovering wireless network keys, revealing password boxes, uncovering cached passwords and analyzing routing protocols. | **\*** |
| cree.py | [http://ilektrojohn.github.com/creepy/](http://ilektrojohn.github.com/creepy/) | cree.py gathers geolocation related information from social networking platforms and image hosting services. Then the information is presented in a map where all the retrieved data is shown accompanied with relevant information (i.e. what was posted from that specific location) to provide context. |  |
| inSSIDer | [http://www.metageek.net/products/inssider](http://www.metageek.net/products/inssider) | inSSIDer is a free gui-based wifi discovery and troubleshooting tool for Windows | **\*** |
...
| dnsenum | [http://code.google.com/p/dnsenum](http://code.google.com/p/dnsenum) | Think of dnsenum as a supercharged version of a whois query. It not only discovers all of the dns records but it goes a step further and attempts to use google to discover subdomains, discovers BIND versions and more. |  |
| dnsmap | [http://code.google.com/p/dnsmap](http://code.google.com/p/dnsmap) | Dnsmap is a passive dns mapper that is used for subdomain bruteforce discovery. |  |
| dnsrecon | [http://www.darkoperator.com/tools-and-scripts/](http://www.darkoperator.com/tools-and-scripts/) | DNS enumeration script written in ruby for performing TLD expansion, SRV record enumeration, host and subdomain brute force, zone transfer, reverse lookup and general record identification. |  |
| dnstracer | [http://www.mavetju.org/unix/dnstracer.php](http://www.mavetju.org/unix/dnstracer.php) | dnstracer determines where a given Domain Name Server (DNS) gets its information from and follows the chain of DNS servers back to the servers which know the data. |  |
| dnswalk | [http://sourceforge.net/projects/dnswalk](http://sourceforge.net/projects/dnswalk) | Dnswalk is a DNS debugger. It performs zone transfers of specified domains, and checks the database in numerous ways for internal consistency, as well as accuracy. |  |
| Fierce | [http://ha.ckers.org/fierce](http://ha.ckers.org/fierce) | Fierce domain scan discovers non-contiguous IP ranges of a network. |  |
| Fierce2 | [http://trac.assembla.com/fierce/](http://trac.assembla.com/fierce/) | Fierce 2 is an updated version that is maintained by a new group of developers. |  |
| FindDomains | [http://code.google.com/p/finddomains](http://code.google.com/p/finddomains) | FindDomains is a multithreaded search engine discovery tool that will be very useful for penetration testers dealing with discovering domain names/web sites/virtual hosts which are located on too many IP addresses. Provides a console interface so you can easily integrate this tool to your pentesting automation system. | **\*** |
...
| URLcrazy | [http://www.morningstarsecurity.com/research/urlcrazy](http://www.morningstarsecurity.com/research/urlcrazy) | URLCrazy is a domainname typo generator. This will allow you to find squatted domains related to your target company and possibly generate some of your own. |  |
| theHarvester | [http://www.edge-security.com/theHarvester.php](http://www.edge-security.com/theHarvester.php) | theHarvester is a tool for gathering e-mail accounts, user names and hostnames/subdomains from different public sources like search engines and PGP key servers. |  |
...
| The Social-Engineer Toolkit (SET) | [http://www.secmaniac.com/download/](http://www.secmaniac.com/download/) | The Social-Engineer Toolkit (SET) is specifically designed to perform advanced attacks against the human element. Amongst other things, SET allows you to craft malcious emails and dummy websites based on legitimate ones to compliment a social engineering attack. |  |
| Fast-Track | [http://www.secmaniac.com/download/](http://www.secmaniac.com/download/) | Fast-Track is an automated pentesting tool suite. Many of the issues Fast-Track exploits are due to improper sanitizing of client-side data within web applications, patch management, or lack of hardening techniques. It runs on Linux and depends on Metasploit 3. |  |
...
| Indiana | [http://secure.in.gov/sos/bus\_service/online\_corps/default.asp](http://secure.in.gov/sos/bus_service/online_corps/default.asp) |
...
| Michigan | [http://www.cis.state.mi.us/bcs\_corp/sr\_corp.asp](http://www.cis.state.mi.us/bcs_corp/sr_corp.asp) |
...
| New York | [http://wdb.dos.state.ny.us/corp\_public/corp\_wdb.corp\_search\_inputs.show](http://wdb.dos.state.ny.us/corp_public/corp_wdb.corp_search_inputs.show) |
...
| Oregon | [http://egov.sos.state.or.us/br/pkg\_web\_name\_srch\_inq.login](http://egov.sos.state.or.us/br/pkg_web_name_srch_inq.login) |
...
| South Carolina | [http://www.scsos.com/corp\_search.htm](http://www.scsos.com/corp_search.htm) |
...
| Wyoming | [http://soswy.state.wy.us/Corp\_Search\_Main.asp](http://soswy.state.wy.us/Corp_Search_Main.asp) |
...
| aNobii | [http://www.anobii.com/anobii\_home](http://www.anobii.com/anobii_home) | Books |
...
| Google Buzz | [http://www.google.com/buzz](http://www.google.com/buzz) | General |
...
| LibraryThing | [http://www.librarything.com/](http://www.librarything.com/)<br>(German) [http://www.librarything.de](http://www.librarything.de/) | Book lovers |
...
| PicFog | [http://picfog.com](http://picfog.com/) | PicFog shows pictures from twitter _as_ they're posted |
...
| Vkontakte | [http://vkontakte.ru/](http://vkontakte.ru/) | Social Network for Russian-speaking world including former Soviet republics. Biggest site in Russia |
...
| Wakoopa | [http://social.wakoopa.com](http://social.wakoopa.com/) | For computer fans that want to discover new software and games |
| Wattpad | [http://www.wattpad.com](http://www.wattpad.com/) | For readers and authors to interact & e-book sharing |
| Wasabi | [http://www.wasabi.com](http://www.wasabi.com/) | General. UK-based. |
| WAYN | [http://www.wayn.com](http://www.wayn.com/) | Travel and lifestyle |
| WebBiographies | [http://www.webbiographies.com](http://www.webbiographies.com/) | Genealogy and biography |
| WeeWorld | [http://www.weeworld.com](http://www.weeworld.com/) | Teenagers - 10 to 17 |
| WeOurFamily | [http://www.weourfamily.com](http://www.weourfamily.com/) | General with emphasis on privacy and security |
| Wer-kennt-wen | [http://www.wer-kennt-wen.de](http://www.wer-kennt-wen.de/) | General |
| weRead | [http://weread.com](http://weread.com/) | Books |
| Windows Live Spaces | [http://spaces.live.com](http://spaces.live.com/) | Blogging (formerly MSN Spaces) |
| WiserEarth | [http://www.wiserearth.org](http://www.wiserearth.org/) | Online community space for the social justice and environmental movement |
| Wordpress | [http://wordpress.org](http://wordpress.org/) |  |
| WorldFriends | [http://www.worldfriends.tv](http://www.worldfriends.tv/) |  |
| Xanga | [http://www.xanga.com](http://www.xanga.com/) | Blogs and "metro" areas |
| XING | [http://www.xing.com](http://www.xing.com/) | Business (primarily Europe (Germany, Austria, Switzerland) and China) |
| Xt3 | [http://www.xt3.com](http://www.xt3.com/) | Catholic social networking, created after World Youth Day 2008 |
| Yammer | [http://www.yammer.com](http://www.yammer.com/) | Social networking for office colleagues |
| Yelp, Inc. | [http://www.yelp.com](http://www.yelp.com/) | Local Business Review and Talk |
| Yfrog | [http://yfrog.com](http://yfrog.com/) |  |
| Youmeo | [http://youmeo.com](http://youmeo.com/) | UK Social Network (focus on data portability) |
| Zoo.gr | [http://www.zoo.gr](http://www.zoo.gr/) | Greek Web Meeting point |
| Zooppa | [http://zooppa.com](http://zooppa.com/) | Online Community for Creative Talent (host of brand sponsored advertising contests) |
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_07.png "File:Penetration Testing Execution 07.png")
...
- [Check Usernames](http://www.checkusernames.com/) \- Useful for checking the existence of a given username across 160 Social Networks.
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_09.png "File:Penetration Testing Execution 09.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_10.png "File:Penetration Testing Execution 10.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_11.png "File:Penetration Testing Execution 11.png")

The command to run _metagoofil_ is as follows:
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_12.png "File:Penetration Testing Execution 12.png")
...
| Radio Reference | [http://www.radioreference.com/apps/db/](http://www.radioreference.com/apps/db/) | Free part of the site containing a wealth of information |
| National Radio Data | [http://www.nationalradiodata.com/](http://www.nationalradiodata.com/) | FCC database search / $29 year |
| Percon Corp | [http://www.perconcorp.com](http://www.perconcorp.com/) | FCC database search / Paid site - custom rates |

[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_13.png "File:Penetration Testing Execution 13.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_14.png "File:Penetration Testing Execution 14.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_15.png "File:Penetration Testing Execution 15.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_16.png "File:Penetration Testing Execution 16.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_17.png "File:Penetration Testing Execution 17.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_18.png "File:Penetration Testing Execution 18.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_19.png "File:Penetration Testing Execution 19.png")

[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_20.png "File:Penetration Testing Execution 20.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_21.png "File:Penetration Testing Execution 21.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_22.png "File:Penetration Testing Execution 22.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_23.png "File:Penetration Testing Execution 23.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_24.png "File:Penetration Testing Execution 24.png")

Kismet presents us with the options to choose as part of the server startup process.

[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_25.png "File:Penetration Testing Execution 25.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_26.png "File:Penetration Testing Execution 26.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_27.png "File:Penetration Testing Execution 27.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_28.png "File:Penetration Testing Execution 28.png")
...
- InterNIC - [http://www.internic.net/](http://www.internic.net/) [http://www.internic.net](http://www.internic.net/)\]
...
The command to run _fierce2_ is as follows:

```
fierce -dns <client domain> -prefix <wordlist>
```

[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_29.png "File:Penetration Testing Execution 29.png")
...
[https://address-unknown/](https://address-unknown/)
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_30.png "File:Penetration Testing Execution 30.png")

The command to run _dnsenum_ is as follows:

```
dnsenum -enum -f <wordlist> <client domain>
```

[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_31.png "File:Penetration Testing Execution 31.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_32.png "File:Penetration Testing Execution 32.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_37.png "File:Penetration Testing Execution 37.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_39.png "File:Penetration Testing Execution 39.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_40.png "File:Penetration Testing Execution 40.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_45.png "File:Penetration Testing Execution 45.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_49.png "File:Penetration Testing Execution 49.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_50.png "File:Penetration Testing Execution 50.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_51.png "File:Penetration Testing Execution 51.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_52.png "File:Penetration Testing Execution 52.png")

Once the client starts up you will need to connect it to the scanner.

[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_53.png "File:Penetration Testing Execution 53.png")

Submit in the supplied user credentials.

[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_54.png "File:Penetration Testing Execution 54.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_55.png "File:Penetration Testing Execution 55.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_56.png "File:Penetration Testing Execution 56.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_57.png "File:Penetration Testing Execution 57.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_58.png "File:Penetration Testing Execution 58.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_59.png "File:Penetration Testing Execution 59.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_60.png "File:Penetration Testing Execution 60.png")

Finally, we're at the point where we can launch our scan. Click Execute to start the scan.

[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_61.png "File:Penetration Testing Execution 61.png")

[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_62.png "File:Penetration Testing Execution 62.png")

[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_63.png "File:Penetration Testing Execution 63.png")

[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_64.png "File:Penetration Testing Execution 64.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_65.png "File:Penetration Testing Execution 65.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_66.png "File:Penetration Testing Execution 66.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_67.png "File:Penetration Testing Execution 67.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_68.png "File:Penetration Testing Execution 68.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_69.png "File:Penetration Testing Execution 69.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_70.png "File:Penetration Testing Execution 70.png")
...
_Note:_ Automated tools can sometimes be too aggressive by default and need to be scaled back if the customer is affected.
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_71.png "File:Penetration Testing Execution 71.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_72.png "File:Penetration Testing Execution 72.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_73.png "File:Penetration Testing Execution 73.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_74.png "File:Penetration Testing Execution 74.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_75.png "File:Penetration Testing Execution 75.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_76.png "File:Penetration Testing Execution 76.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_77.png "File:Penetration Testing Execution 77.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_78.png "File:Penetration Testing Execution 78.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_79.png "File:Penetration Testing Execution 79.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_80.png "File:Penetration Testing Execution 80.png")

Go to the _Devices_ page to list assets for your new site. IP addresses and/or hostnames can be manually entered in the text box labeled _Dev_ i _ces to scan_. It is also possible to import a comma separated file that lists IP address and/or the host names of targets you want to scan. You do have to ensure that each address/hostname in the file appears on its own line.

To import a target list file, click the Browse' _**button in the** Included Device's'_ area, and select the appropriate file.

If you need to exclude targets from a scan, the process is the sample however; it is performed under the area labeled ' _Devices to Exclude'._

Once the targets have been added, a scan template will need to be selected from the ' _Scan Setup'_ page. To select a scan template simply browse the available templates. The scan engine drop down allows you to choose between the local scan engine and the Rapid 7 hosted scan engine.

[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_81.png "File:Penetration Testing Execution 81.png")
...
From the **Alerting; _page and click the ''_ New Alert'** button.

[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_82.png "File:Penetration Testing Execution 82.png")

The console displays a **New Alert' _dialog box. Click the ''_ Enable alert'** check box to ensure that NeXpose generates this type of alert. You can click the box again at any time to disable the alert if you prefer not to receive that alert temporarily without having to delete it.

[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_83.png "File:Penetration Testing Execution 83.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_84.png "File:Penetration Testing Execution 84.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_85.png "File:Penetration Testing Execution 85.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_86.png "File:Penetration Testing Execution 86.png")

By selecting the appropriate assets view you can select the results that you wish to view.

[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_87.png "File:Penetration Testing Execution 87.png")

To create a report, click on the 'Create Site Report' button. This will take you to the 'New Report' 'Configuration' page.

[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_88.png "File:Penetration Testing Execution 88.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_89.png "File:Penetration Testing Execution 89.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_90.png "File:Penetration Testing Execution 90.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_91.png "File:Penetration Testing Execution 91.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_92.png "File:Penetration Testing Execution 92.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_93.png "File:Penetration Testing Execution 93.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_94.png "File:Penetration Testing Execution 94.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_95.png "File:Penetration Testing Execution 95.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_96.png "File:Penetration Testing Execution 96.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_97.png "File:Penetration Testing Execution 97.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_98.png "File:Penetration Testing Execution 98.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:CoreWEBrpt.jpg "File:CoreWEBrpt.jpg")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:CoreWEBcrawl.jpg "File:CoreWEBcrawl.jpg")
...
[Screenshot Here](http://www.pentest-standard.org/index.php?title=File:Corerptmodules.jpg&action=edit&redlink=1 "File:Corerptmodules.jpg (page does not exist)")
...
FAST: quickly runs the most common tests, NORMAL: runs the tests that are in the FAST plus some additional tests FULL: runs all tests (for details on what the difference tests check for, select the modules tab, navigate to the Exploits \| SQL Injection section and view the contents of the SQL Injection Analyzer paying attention to the fuzz\_strings). Adding information about known custom error pages and any session arguments will enhance testing.
...
[Screenshot Here](http://www.pentest-standard.org/index.php?title=File:CoreWEBagendeployed.jpg&action=edit&redlink=1 "File:CoreWEBagendeployed.jpg (page does not exist)")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Corewireless.jpg "File:Corewireless.jpg")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:CoreCSrpt.jpg "File:CoreCSrpt.jpg")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:CoreCSattacktype.jpg "File:CoreCSattacktype.jpg") [Screenshot Here](http://www.pentest-standard.org/index.php/File:CoreCSsingle.jpg "File:CoreCSsingle.jpg") [Screenshot Here](http://www.pentest-standard.org/index.php/File:CoreCSmulti.jpg "File:CoreCSmulti.jpg") [Screenshot Here](http://www.pentest-standard.org/index.php/File:CoreCSphish.jpg "File:CoreCSphish.jpg")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Corerptormodules.jpg "File:Corerptormodules.jpg")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:CoreCSusb.jpg "File:CoreCSusb.jpg")
...
Screenshot Here SAINT\_Remote\_host.png refers (included).
...
Screenshot Here SAINT\_scanning\_options.png refers (included).
...
Screenshot here SAINT\_policy\_setup.png refers (included).
...
Screenshot here SAINT\_scansetup1.png refers (included).
Step 3 Select Scan Policy Type
Step 4 Determine Firewall settings for Target
Step 5 Select Scan Now
Screenshot here SAINT\_scansetup2.png refers (included).
...
Screenshot here SAINT\_connections.png refers (included)
...
Screenshot here SAINT\_filemgr.png refers (included)
...
Screenshot here SAINT\_cmd.png refers (included)
The Screenshot Tool can be used against an exploited host to grab a screenshot for the report.
Screenshot here SAINT\_screen.png refers (included)
...
Screenshot here SAINT\_client1.png refers (included)
...
Screenshot here SAINT\_writer.png refers (included).
A sample report is available here and here SAINT\_report1.pdf and SAINT\_report2.pdf refer (included)
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_99.png "File:Penetration Testing Execution 99.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_100.png "File:Penetration Testing Execution 100.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_101.png "File:Penetration Testing Execution 101.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_102.png "File:Penetration Testing Execution 102.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_103.png "File:Penetration Testing Execution 103.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_104.png "File:Penetration Testing Execution 104.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_105.png "File:Penetration Testing Execution 105.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_106.png "File:Penetration Testing Execution 106.png")

Ensure that the select Run Profiler Automatically box is checked. Click Next to continue.

[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_107.png "File:Penetration Testing Execution 107.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_108.png "File:Penetration Testing Execution 108.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_109.png "File:Penetration Testing Execution 109.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_110.png "File:Penetration Testing Execution 110.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_111.png "File:Penetration Testing Execution 111.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_112.png "File:Penetration Testing Execution 112.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_113.png "File:Penetration Testing Execution 113.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_114.png "File:Penetration Testing Execution 114.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_115.png "File:Penetration Testing Execution 115.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_116.png "File:Penetration Testing Execution 116.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_117.png "File:Penetration Testing Execution 117.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_118.png "File:Penetration Testing Execution 118.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_119.png "File:Penetration Testing Execution 119.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_120.png "File:Penetration Testing Execution 120.png")

Exploit6 is another tool from the THC-IPV6 Attack Toolkit which can test for known ipv6 vulnerabilities.

[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_121.png "File:Penetration Testing Execution 121.png")

[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_122.png "File:Penetration Testing Execution 122.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_123.png "File:Penetration Testing Execution 123.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_124.png "File:Penetration Testing Execution 124.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_125.png "File:Penetration Testing Execution 125.png")

**SIPSAK**

SIPSAK is tool that can test for SIP enabled applications and devices using the OPTION request method only.

[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_126.png "File:Penetration Testing Execution 126.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_127.png "File:Penetration Testing Execution 127.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_128.png "File:Penetration Testing Execution 128.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_129.png "File:Penetration Testing Execution 129.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_130.png "File:Penetration Testing Execution 130.png")
...
- Black Asylum - [http://www.blackasylum.com/?p=160](http://www.blackasylum.com/?p=160)
...
- [http://www.isdpodcast.com/resources/62k-common-passwords/](http://www.isdpodcast.com/resources/62k-common-passwords/)
...
As you can see, some of these values are not hard to figure out. Except for maybe the LowDateTime and the performance counter. An excellent paper has been written concerning this lack of entropy. More information can be found in that paper here ( [Exploiting the otherwise non-exploitable](http://j00ru.vexillium.org/?p=690))
...
On a linux machine, there are a few different ways of creating a thread. One of them is called fork(). When using fork to create a new thread, the application will "quickly" create a new thread which will reuse the calculated cookie for each new "fork"-ed thread. If a buffer overflow would exist in this forked thread, an attacker could bruteforce the stack canarie. Once again a great article describing this attack can be found here ( [Scraps of notes on remote stack overflow exploitation](http://www.phrack.org/issues.html?issue=67&id=13))
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_131.png "File:Penetration Testing Execution 131.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_132.png "File:Penetration Testing Execution 132.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_133.png "File:Penetration Testing Execution 133.png")
...
POP3. Brutus can perform both _dictionary_ and randomly generated attacks from a given character set.

[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_134.png "File:Penetration Testing Execution 134.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_135.png "File:Penetration Testing Execution 135.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_136.png "File:Penetration Testing Execution 136.png")

[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_137.png "File:Penetration Testing Execution 137.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_138.png "File:Penetration Testing Execution 138.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_139.png "File:Penetration Testing Execution 139.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_140.png "File:Penetration Testing Execution 140.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_141.png "File:Penetration Testing Execution 141.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_142.png "File:Penetration Testing Execution 142.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_143.png "File:Penetration Testing Execution 143.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_144.png "File:Penetration Testing Execution 144.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_145.png "File:Penetration Testing Execution 145.png")
...
Next we need to set the operating mode of the device, which depends on the network topology. Setting this to _Managed_ means that we are connecting to a network that is composed of access points.
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_146.png "File:Penetration Testing Execution 146.png")

Windows XP will show an icon with a notification that says it has found wireless networks.

[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_147.png "File:Penetration Testing Execution 147.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_148.png "File:Penetration Testing Execution 148.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_149.png "File:Penetration Testing Execution 149.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_150.png "File:Penetration Testing Execution 150.png")

You can scroll down through the list of available networks. Once you decided on which network to connect to, click on it. Next, click on the _Connect_ button.

[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_151.png "File:Penetration Testing Execution 151.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_152.png "File:Penetration Testing Execution 152.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_153.png "File:Penetration Testing Execution 153.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_154.png "File:Penetration Testing Execution 154.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_155.png "File:Penetration Testing Execution 155.png")

Enter "iwconfig" to validate the wireless interfaces. The output should look similar to:

[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_156.png "File:Penetration Testing Execution 156.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_157.png "File:Penetration Testing Execution 157.png")

[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_158.png "File:Penetration Testing Execution 158.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_159.png "File:Penetration Testing Execution 159.png")
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_160.png "File:Penetration Testing Execution 160.png")
...
The KoreK chopchop attack can decrypt a WEP data packet without knowing the key. It can even work against dynamic WEP. _This attack does not recover the WEP key itself, it merely reveals the plaintext_. Some APs are not vulnerable to this attack. They may seem vulnerable at first but actually drop data packets shorter than 60 bytes. If the AP drops packets shorter than 42 bytes, Aireplay tries to guess the rest of the missing data, as far as the headers are predictable. If an IP packet is captured Aireplay checks if the checksum of the header is correct after guessing its missing parts. Remember that this attack requires at least one WEP data packet.
...
[Screenshot Here](http://www.pentest-standard.org/index.php/File:Penetration_Testing_Execution_161.png "File:Penetration Testing Execution 161.png")
...
Finally, the Metasploit Framework itself needs to be configured. While its possible to configure each service by hand, its more efficient to use a resource file with the msfconsole interface. A sample resource file, configured to use 10.0.0.1 as the access point address, with nearly every feature enabled, can be downloaded here [\[2\]](http://digitaloffense.net/tools/karma.rc). To use this resource file, run msfconsole with the -r parameter. Keep in mind that msfconsole must be run as root for the capture services to function.
...
According to OWASP ( [https://www.owasp.org/index.php/SQL\_Injection](https://www.owasp.org/index.php/SQL_Injection)) SQL Injection, also known as SQLi, consists of insertion or "injection" of a SQL query via the input data from the client to the application.
...
- Havij ( [http://itsecteam.com/en/projects/project1.htm](http://itsecteam.com/en/projects/project1.htm))
- SQLmap ( [http://sqlmap.sourceforge.net](http://sqlmap.sourceforge.net/))
- The Mole ( [http://sourceforge.net/projects/themole](http://sourceforge.net/projects/themole))
- Pangolin ( [http://nosec.org/en/productservice/pangolin](http://nosec.org/en/productservice/pangolin))
...
One quick way to find the repo is to look for the file [http://example.com/.git/HEAD](http://example.com/.git/HEAD) and see if it contains a match to ^ref: refs/ W3AF ( [http://w3af.sourceforge.net/](http://w3af.sourceforge.net/)) contains a discovery plugin named findGit.py that will assist in finding git repositories of web targets.

Note: the .git directory is not always present in the root, but sometimes in sub directories depending on how a part of the application is deployed. Something like [http://example.com/blog/.git/](http://example.com/blog/.git/)
...
If directory browsing is open for [http://example.com/.git/objects](http://example.com/.git/objects) then wget can be used to download the repo and then re-construct it.
...
“The index is a binary file (generally kept in .git/index) containing a sorted list of path names, each with permissions and the SHA1 of a blob object; git ls-files can show you the contents of the index:” ( [http://book.git-scm.com/7\_the\_git\_index.html](http://book.git-scm.com/7_the_git_index.html))
...
1 loopback localhost # loopback (lo0) name/address1FFF ipv6test.example.com ipv6test

--Pull hostnames from known\_hosts files for any user home you have
access to read.
for i in $(awk -F: '{print $6}' /etc/passwd\|sort -u); do awk '{print
$1}' ${i}/.ssh/known\_hosts 2> /dev/null;done\|tr ',' '\\n'\|sort -u
testhost
testhost3
testhost4
ipv6test
...
| `who` | Display who is on the system <br>Check ssh known hosts file<br>Log files to see who connects to the server |

.bash\_history and other shell history files
syslog
...
| `%SYSTEMROOT%\repair\SAM`<br>`%SYSTEMROOT%\System32\config\RegBack\SAM` | It stores users' passwords in a hashed format (in LM hash and NTLM hash). |
...
| `netstat -nao | findstr LISTENING` | XP and up for -o flag to get PIDnet acc |
...
| `net view /domain`<br>`net view /domain:otherdomain` |  |
...
[http://www.securityaegis.com/ntsd-backdoor/](http://www.securityaegis.com/ntsd-backdoor/)
...
| `net use \\computername /user:DOMAIN\username password` | Using the IPC$ mount use a user name and password allows you to access commands that do not usually ask for a username and password as a different user in the context of the remote system.<br>This is useful when you’ve gotten credentials from somewhere and wish to use them but do not have an active token on a machine you have a session on. |
...
| `%SystemRoot%\System32\wbem\mof\` | Taken from stuxnet: [http://blogs.iss.net/archive/papers/ibm-xforce-an-inside-look-at-stuxnet.pdf](http://blogs.iss.net/archive/papers/ibm-xforce-an-inside-look-at-stuxnet.pdf) Look for Print spooler vuln |
...
``In Meterpreter use the command run post/windows/gather/hashdump to get the local hashes from the SAM database.
To get the cached hashes you will need to download the cachedump.rb module from http://lab.mediaservice.net/code/cachedump.rb and put it into <msf3>/modules/post/windows/gather. Then you can run the command run post/windows/gather/cachedump.
...
Retrieved from " [http://www.pentest-standard.org/index.php?title=PTES\_Technical\_Guidelines&oldid=921](http://www.pentest-standard.org/index.php?title=PTES_Technical_Guidelines&oldid=921)"

## Navigation menu

### Personal tools

- [Log in](http://www.pentest-standard.org/index.php?title=Special:UserLogin&returnto=PTES+Technical+Guidelines "You are encouraged to log in; however, it is not mandatory [alt-shift-o]")

### Namespaces

- [Page](http://www.pentest-standard.org/index.php/PTES_Technical_Guidelines "View the content page [alt-shift-c]")
- [Discussion](http://www.pentest-standard.org/index.php?title=Talk:PTES_Technical_Guidelines&action=edit&redlink=1 "Discussion about the content page (page does not exist) [alt-shift-t]")

### Variants

### Views

- [Read](http://www.pentest-standard.org/index.php/PTES_Technical_Guidelines)
- [View source](http://www.pentest-standard.org/index.php?title=PTES_Technical_Guidelines&action=edit "This page is protected. You can view its source [alt-shift-e]")
- [View history](http://www.pentest-standard.org/index.php?title=PTES_Technical_Guidelines&action=history "Past revisions of this page [alt-shift-h]")

### More

### Search

[Visit the main page](http://www.pentest-standard.org/index.php/Main_Page "Visit the main page")

### Navigation

- [Main page](http://www.pentest-standard.org/index.php/Main_Page "Visit the main page [alt-shift-z]")
- [PTES Technical Guideline](http://www.pentest-standard.org/index.php/PTES_Technical_Guidelines)
- [In the Media](http://www.pentest-standard.org/index.php/Media)
- [FAQ](http://www.pentest-standard.org/index.php/FAQ)

### Tools

- [What links here](http://www.pentest-standard.org/index.php/Special:WhatLinksHere/PTES_Technical_Guidelines "A list of all wiki pages that link here [alt-shift-j]")
- [Related changes](http://www.pentest-standard.org/index.php/Special:RecentChangesLinked/PTES_Technical_Guidelines "Recent changes in pages linked from this page [alt-shift-k]")
- [Special pages](http://www.pentest-standard.org/index.php/Special:SpecialPages "A list of all special pages [alt-shift-q]")
- Printable version
- [Permanent link](http://www.pentest-standard.org/index.php?title=PTES_Technical_Guidelines&oldid=921 "Permanent link to this revision of the page")
- [Page information](http://www.pentest-standard.org/index.php?title=PTES_Technical_Guidelines&action=info "More information about this page")

- This page was last edited on 30 April 2012, at 06:04.
- Content is available under [GNU Free Documentation License 1.2](http://www.gnu.org/licenses/old-licenses/fdl-1.2.txt) unless otherwise noted.

- [Privacy policy](http://www.pentest-standard.org/index.php/The_Penetration_Testing_Execution_Standard:Privacy_policy "The Penetration Testing Execution Standard:Privacy policy")
- [About The Penetration Testing Execution Standard](http://www.pentest-standard.org/index.php/The_Penetration_Testing_Execution_Standard:About "The Penetration Testing Execution Standard:About")
- [Disclaimers](http://www.pentest-standard.org/index.php/The_Penetration_Testing_Execution_Standard:General_disclaimer "The Penetration Testing Execution Standard:General disclaimer")

- [![GNU Free Documentation License 1.2](http://www.pentest-standard.org/resources/assets/licenses/gnu-fdl.png)](http://www.gnu.org/licenses/old-licenses/fdl-1.2.txt)
- [![Powered by MediaWiki](http://www.pentest-standard.org/resources/assets/poweredby_mediawiki_88x31.png)](https://www.mediawiki.org/)