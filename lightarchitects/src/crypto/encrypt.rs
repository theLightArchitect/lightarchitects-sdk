...
use crate::crypto::derive::DerivedBytes;
...
pub fn seal(key: &[u8; 32], plaintext: &[u8], associated_data: &[u8]) -> Result<SealedData> {
    ...
    let nonce_bytes = crate::crypto::random::generate_nonce();
...
pub fn seal_with_verse(
    ...
    let derived = crate::crypto::derive::derive_key(pepper, &ikm, verse, "encryption")?;
