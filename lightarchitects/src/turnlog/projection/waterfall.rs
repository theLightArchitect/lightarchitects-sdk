...
//!
//! With the AYIN alignment refactor, every [`crate::turnlog::entry::TurnEntry`] wraps
...
//! `TurnEntry::span` directly, or read entries via [`crate::turnlog::reader::TurnLogReader`]
