...
//!
//! With the AYIN alignment refactor, every [`lightarchitects::turnlog::entry::TurnEntry`] wraps
...
//! `TurnEntry::span` directly, or read entries via [`lightarchitects::turnlog::reader::TurnLogReader`]
