 ...
 * Used by Geometry4DScene for stereographic projection rendering.
 */
...
/** Dual compound: tesseract + 16-cell interpenetrating — two shapes forming one emergent geometry.
 *  24 vertices, 56 edges. Neither shape alone creates this structure. */
