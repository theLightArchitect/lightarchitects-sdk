...
export default defineConfig({
  ...
  testMatch: ['**/webshell.spec.ts', '**/conversational.spec.ts', '**/northstar.spec.ts', '**/vibe-coding.spec.ts', '**/e3.spec.ts', '**/e4.spec.ts', '**/e5.spec.ts', '**/e6-golden-path.spec.ts', '**/helix-viz-remap.spec.ts', '**/ironclaw-phase6.spec.ts', '**/roadmap.spec.ts', '**/tool-surface-parity.spec.ts', '**/fleet.spec.ts', '**/mock-overlay.spec.ts', '**/project-ingestion.spec.ts', '**/panel-drag-split.spec.ts', '**/helix-retrieval.spec.ts', '**/ayin-lineage.spec.ts', '**/chatroom.spec.ts', '**/agent-runner-containers.spec.ts', '**/cockpit.spec.ts', '**/cockpit-scope-routes.spec.ts', '**/lightspace-materialize.spec.ts', '**/lightspace-provenance.spec.ts', '**/lightspace-graduate.spec.ts', '**/lightspace-gating.spec.ts', '**/lightspace-branch-lane.spec.ts', '**/lightspace-replay.spec.ts'],
  ...
  use: {
    ...
    // Chatroom spec uses window.__e2e injection and runs headless in CI (no display).
