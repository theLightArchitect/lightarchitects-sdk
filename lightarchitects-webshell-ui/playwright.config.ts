...
export default defineConfig({
  ...
  testMatch: ['**/webshell.spec.ts', '**/conversational.spec.ts', '**/northstar.spec.ts', '**/vibe-coding.spec.ts', '**/e3.spec.ts', '**/e4.spec.ts', '**/e5.spec.ts', '**/e6-golden-path.spec.ts', '**/helix-viz-remap.spec.ts', '**/ironclaw-phase6.spec.ts', '**/roadmap.spec.ts'],
