...
//!
//! ```no_run
//! use lightarchitects_turnlog::{TurnLogReader, StoreLayout, query::Query};
//! use lightarchitects_turnlog::entry::EntryKind;
//!
...
use crate::reader::TurnLogReader;
...
impl Query {
    ...
    /// # Errors
    ///
    /// Returns [`crate::error::TurnLogError`] if the session file cannot be
    /// read or parsed.
