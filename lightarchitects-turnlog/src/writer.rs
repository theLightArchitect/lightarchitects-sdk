...
//! detectable — [`crate::chain::verify_chain`] fails at the seq of the
...
impl TurnLogWriter {
    ...
    /// [`lightarchitects_core::paths::session_key`]).
    ...
    /// [`crate::reader::TurnLogReader`] will surface it as a resumable session.
    ///
