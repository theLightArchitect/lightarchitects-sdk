...
use crate::chain::{GenesisBlock, derive_session_key, sign_entry, verify_chain};
use crate::entry::{EntryKind, TurnEntry};
...
mod tests {
    ...
    use crate::writer::TurnLogWriter;
    ...
    async fn warm_compaction_writes_rollup_and_deletes_original() {
        ...
        writer
            .close(crate::writer::EndReason::Complete)
            .await
            .unwrap();
